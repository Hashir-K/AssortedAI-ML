...
#NOTE: THE above code won't run properly because PyTorch is needed and Python3.14 which i have installed doesn't support it. Python 3.12 supports it. Installing taht should make it work
